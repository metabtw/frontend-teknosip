      ...
      <CategoryProvider>
        <div className="min-h-screen bg-gray-50">
                  ...
                  <ol className="flex items-center space-x-4">
                    ...
                    <li>
                      <div className="flex items-center">
                        ...
                        <a href="/admin/categories" className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">
                          Kategori Yönetimi
                        </a>
                      </div>
                    </li>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <CategoryManagement showInactive={true} />
          </div>
...
export default InactiveCategoriesPage;